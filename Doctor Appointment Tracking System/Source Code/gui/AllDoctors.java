...
public class AllDoctors extends JFrame {
	...
	public AllDoctors() 
	{
		...
		scrollPane.setBounds(10, 58, 789, 484);
		contentPane.add(scrollPane);
		
		table = new JTable();
		scrollPane.setViewportView(table);
		
		JLabel lblAllDoctorDetails = new JLabel("ALL DOCTOR DETAILS");
	...
	public void showTable()
	{
		...
		ResultSet rs=null;
		String strsql= "select * from doctor_details";
